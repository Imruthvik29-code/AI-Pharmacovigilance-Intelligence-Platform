...
export type PatientResponse = { id: string; user_id: string; name: string; age: number | null; sex: string | null; weight_kg: number | null; renal_flag: boolean; hepatic_flag: boolean; created_at: string; updated_at: string };
export type PatientCreate = { name: string; age?: number | null; sex?: string | null; weight_kg?: number | null; renal_flag?: boolean; hepatic_flag?: boolean };
export type MedicationStatus = "active" | "completed" | "completed_early" | "paused" | "discontinued";
export type MedicationResponse = { id: string; patient_id: string; condition_id: string | null; purpose_text: string | null; drug_id: string; dose: string | null; times_per_day: number | null; interval_hours: number | null; duration_days: number | null; status: MedicationStatus; start_date: string; end_date: string | null; created_at: string; updated_at: string };
...
export type ReferenceDrugSearchResult = { id: string; name: string; rxcui: string | null; source: string | null; term_type: string | null };
