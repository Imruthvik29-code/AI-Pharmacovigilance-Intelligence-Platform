...
def _configure_env(monkeypatch):
    ...
    yield
    # This module exercises /auth/me with deliberately invalid tokens. Those
    # requests can initialize the module-level JWKS client against the mocked
    # example URL, so never let that client leak into the next test module.
